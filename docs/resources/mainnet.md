...
| Ethereum DAI token address                | `0x6B175474E89094C44Da98b954EedeAC495271d0F` |
| Ethereum USDT token address               | `0xdAC17F958D2ee523a2206206994597C13D831ec7` |
| Ethereum NGM token address                | `0x08fe7A0db575c2a08d76EEcA71763E48C6e60F45` |
| Ethereum EEUR token address               | `0xDd26a5c8Ae5b60Bb14aEcED892A052CA48A2e915` |
...
| Avalanche axlDAI token address            | `0xC5Fa5669E326DA8B2C35540257cD48811F40a36B` |
| Avalanche axlUSDT token address           | `0xF976ba91b6bb3468C91E4f02E68B37bc64a57e66` |
| Avalanche NGM token address               | `0x5A44422beaAA38031f57720d88697105be6970BE` |
| Avalanche EEUR token address              | `0xE1d70994Be12b73E76889412b284A8F19b0DE56d` |
...
| Fantom axlDAI token address               | `0xD5d5350F42CB484036A1C1aF5F2DF77eAFadcAFF` |
| Fantom axlUSDT token address              | `0xd226392C23fb3476274ED6759D4a478db3197d82` |
| Fantom NGM token address                  | `0xE549Caf5f0c3e80b8738CB03ae4fBb4c15b0DD86` |
| Fantom EEUR token address                 | `0x4000aB030f3615d1616b4C71E7129BbE3f1f9C55` |
...
| Polygon axlDAI token address              | `0xDDc9E2891FA11a4CC5C223145e8d14B44f3077c9` |
| Polygon axlUSDT token address             | `0xCeED2671d8634e3ee65000EDbbEe66139b132fBf` |
| Polygon NGM token address                 | `0xC8d5A4E04387EBdaa2c0FBB6858F246116431e9f` |
| Polygon EEUR token address                | `0x8CD51880C0a5dbde37dDdFce8d5B772Fc9007495` |
...
| Moonbeam axlDAI token address             | `0x14dF360966a1c4582d2b18EDbdae432EA0A27575` |
| Moonbeam axlUSDT token address            | `0xDFd74aF792bC6D45D1803F425CE62Dd16f8Ae038` |
| Moonbeam NGM token address                | `0x08fe7A0db575c2a08d76EEcA71763E48C6e60F45` |
| Moonbeam EEUR token address               | `0xDd26a5c8Ae5b60Bb14aEcED892A052CA48A2e915` |
...
| e-Money -> Axelar IBC channel id          | `channel-26`                                 |
| Axelar -> e-Money IBC channel id          | `channel-6`                                  |
